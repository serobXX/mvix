const forms = [
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/1.jpg',
    content: (
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-md-8 col-lg-6 text-center">
              ...
              <p className="h4">
                Find us on <a href="https://www.froala.com">Facebook</a> and{' '}
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/2.jpg',
    content: (
      <section
        className="fdb-block"
        style={{
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/3.jpg',
    content: (
      <section className="fdb-block">
        <div className="container">
          <div className="row justify-content-center">
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/4.jpg',
    content: (
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/5.jpg',
    content: (
      <section className="fdb-block py-0">
        <div
          className="container py-5 my-5"
          style={{
            backgroundImage: `url(/assets/plugins/froala-editor/shapes/4.svg)`
          }}
        >
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/6.jpg',
    content: (
      <section className="fdb-block">
        <div className="container">
          <div className="row justify-content-center">
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/7.jpg',
    content: (
      <section
        className="fdb-block"
        style={{
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/8.jpg',
    content: (
      <section className="fdb-block">
        <div className="container">
          <div className="row justify-content-center">
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/9.jpg',
    content: (
          ...
          <div className="row justify-content-center">
            <div className="col-12  col-md-10 col-lg-8 col-xl-6 text-center">
              <img
                alt="layers"
                height="40"
                src=".//assets/plugins/froala-editor/icons/layers.svg"
              />
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/10.jpg',
    content: (
      <section className="fdb-block">
        <div className="container">
          <div className="row justify-content-center">
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/11.jpg',
    content: (
      <section className="fdb-block">
        <div className="container">
          <div className="row">
            <div className="col-12 col-md-6 m-md-auto ml-lg-0 col-lg-5">
              <img
                alt="goup-chat"
                className="img-fluid"
                src="/assets/plugins/froala-editor/draws/group-chat.svg"
              />
            </div>
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/forms/12.jpg',
    content: (
      <section
        className="fdb-block"
        style={{
          backgroundImage: `url(/assets/plugins/froala-editor/shapes/1.svg)`
        }}
      >
        <div className="container">
          <div className="row justify-content-end">
