const footers = [
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/1.jpg',
    content: (
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/2.jpg',
    content: (
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/3.jpg',
    content: (
      <footer className="fdb-block footer-small">
        <div className="container">
              ...
              <ul className="nav justify-content-center justify-content-md-start align-items-center">
                <li className="nav-item">
                  <a className="nav-link active" href="https://www.froala.com">
                    <img
                      alt="logo"
                      src="/assets/plugins/froala-editor/logo.png"
                      height="40"
                    />
                  </a>
                </li>
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/4.jpg',
    content: (
      <footer className="fdb-block footer-small">
        <div className="container">
          <div className="row text-center align-items-center">
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/5.jpg',
    content: (
      <footer className="fdb-block footer-small">
        <div className="container">
          <div className="row align-items-center">
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/6.jpg',
    content: (
      <footer className="fdb-block footer-small bg-dark">
        <div className="container">
          <div className="row text-center align-items-center">
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/7.jpg',
    content: (
      <footer className="fdb-block footer-small">
        <div className="container">
          <div className="row text-center align-items-center">
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/8.jpg',
    content: (
      <footer className="fdb-block footer-small">
        <div className="container">
          <div className="row align-items-center">
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/9.jpg',
    content: (
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/10.jpg',
    content: (
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/11.jpg',
    content: (
      <footer className="fdb-block footer-small">
        <div className="container">
          <div className="row align-items-center text-center">
            <div className="col-12 col-lg-4 text-lg-left">© 2018 Froala</div>
  ...
  {
    thumbnail: '/assets/plugins/froala-editor/thumbnail/footers/12.jpg',
    content: (
      <footer className="fdb-block footer-large">
        <div className="container">
          <div className="row text-center">
